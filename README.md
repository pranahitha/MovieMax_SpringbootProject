...
Validation
name
Only alphabets (a-z and A-Z) and maximum length is 25
email
One '@' symbol followed by one '.' followed by 2 or 3 characters
phoneNumber
Only numbers and length should be 10
city
Only alphabets and maximum length are 15.
